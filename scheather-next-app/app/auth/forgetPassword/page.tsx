    ...
    <div className="fixed inset-0 bg-white overflow-hidden flex items-center justify-center">
      ...
      <div className="transform scale-[59%] origin-left w-full">
        <div
          ...
          className="ForgetPassword relative w-[1920px] h-[1080px]"
        >
          ...
          <div
            data-layer="SignUp"
            className="Signup w-[750px] h-[720px] left-[114px] top-[207px] absolute bg-blue-200/60 rounded-[30px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.30)]"
          />
          <div
            data-layer="SCHEATHER"
            className="Scheather w-[455px] h-20 left-[261px] top-[86px] absolute justify-start text-cyan-900 text-7xl font-bold font-['Montserrat']"
          >
            SCHEATHER
          </div>
          ...
          <Link href="/auth/login">
            <p
              data-layer="Do you have an account?"
              className="DoYouHaveAnAccount left-[330px] top-[820px] absolute justify-start text-stone-900/50 text-2xl font-normal font-['Montserrat'] cursor-pointer hover:underline transition duration-200"
            >
